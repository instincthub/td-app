...
export const SubmitButton = ({label, type, clicks, ...props}) =>{
  const btnLabel = label ? label:"Submit Form"
  const btnType = type ? type:"submit"
  return (
    <button 
      type={btnType} 
      onClick={clicks ? clicks :''} 
      className="important-btn submit_bt">
        ...
        <span id="btn_label">{btnLabel}</span>
    </button>
