...
export const inputTagErrorEvent = (tags, border=true) =>{
  console.log('Errrr');
    ...
    if (!input_field_wrap.classList.contains('s_err')) {
      ...
      if(border) input_field_wrap.querySelector('.field').style.border = '1px solid var(--TurkishRose)';
      if (input_field_wrap.querySelector('h5')) {
        ...
        msg_tag.textContent = input_field_wrap.querySelector('.text_label').textContent;
      }
