...
import { fetchAPI, spinBtn, handleError, setCookie, getCookie, HOST_URL, reqOptions } from "../components/static/assets/js/help_func";
...
class RegTracker extends React.Component {
  ...
  componentDidMount(){
      ...
      fetchAPI(this, HOST_URL+"/api/v1/assessment/reg_tracker/", requestOptions)
  }
