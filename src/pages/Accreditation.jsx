...
// 	statsData,
// 	studentsData,
// } from "../components/accreditation/AccDummyData";
...
const Accreditation = () => {
	...
	useState(() => {
		...
		fetchAPI(
			setCohortStats,
			HOST_URL() + "/api/v1/assessment/cohort_analytics/",
			requestOptions,
			true
		);
		fetchAPI(
			setStudents,
			HOST_URL() + "/api/v1/assessment/cohort_students/",
			requestOptions,
			true
		);
		fetchAPI(
	...
	return (
		<TechDiversityWrapper>
			...
			<div className="body-container">
				<div className="sidebar">{/* <TableSidebar /> */}</div>
